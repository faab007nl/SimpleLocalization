...
public interface ISimpleLocalization
{
    ...
    public LocalizedHtmlString this[string name, Dictionary<string, string> vars] { get; }
    public LocalizedHtmlString this[string name, Dictionary<string, string> vars, string? fallback = null] { get; }
